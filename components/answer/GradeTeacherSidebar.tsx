...
const GradeTeacherSidebar: React.FC<Props> = ({ openGradeModal }) => {
    ...
    <>
      <div className="fixed top-0 left-0 w-[100px] py-5 flex flex-col items-center bg-gray-900 h-screen h-[100dvh]">
        ...
        <div className="flex flex-col gap-5 mt-3">
          ...
          <Link href={`/classrooms/${classroomID}/requests`}>
            <IoMdMail className="text-5xl text-gray-300" />
          </Link>

          <Link href={`/classrooms/${classroomID}/create-assignment`}>
            <HiPlus className="text-5xl text-gray-300" />
          </Link>

          <button onClick={openGradeModal}>
            <AiFillEdit className="text-5xl text-gray-300" />
          </button>
        </div>
...
export default GradeTeacherSidebar;
